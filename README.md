# Responsive-Portfolio-Menu-mobile
...
# 📖 [Responsive-Portfolio-Menu-mobile] <a name="Responsive-Portfolio-Menu-mobile"></a>


**[Responsive-Portfolio-Menu-mobile]** is a HTML, CSS, and javascript project that teaches how to parse a Figma design to create a UI, use Flexbox to place elements in the page, use DOM and events,use media query to build a fully responsive personal portfolio site.
...
Click here to see this project online: <li><a href="https://abdelazizsoliman.github.io/Menu-mobile//">See project online</a></li>

<!-- GETTING STARTED -->
## 💻 Getting Started <a name="getting-started"></a>

Creating your first "responsive personal portfolio" project
...
```sh
  cd my-folder
  git clone[ (git@github.com:AbdelazizSoliman/Menu-mobile.git)]
```
### Set Up Linters
## Define Linters
...
## 🙏 Acknowledgments <a name="Microverse Inc."></a>
 ...
 Thanks to Microverse for providing a study platform which very usefull and guided me through this project and to my coding partner for the collaborative efforts. 
