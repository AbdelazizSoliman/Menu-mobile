...
Click here to see a live demo of this project online: <li><a href="https://abdelazizsoliman.github.io/Menu-mobile//">Live Demo</a></li>
...
```sh
  cd my-folder
  git clone[ (https://github.com/AbdelazizSoliman/Menu-mobile.git)]
```
